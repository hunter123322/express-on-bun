...
type TouristSpotDocument = TouristSpotType & Document
...
export const TouristGuide: Model<TouristSpotType> =
    mongoose.models.TouristGuide ||
    mongoose.model<TouristSpotType>("TouristGuide", CategoriesSchema)