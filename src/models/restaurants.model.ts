...
type TouristSpotDocument = RestaurantType & Document
...
export const Restaurants: Model<RestaurantType> =
    mongoose.models.Restaurants ||
    mongoose.model<RestaurantType>("Restaurants", CategoriesSchema)
